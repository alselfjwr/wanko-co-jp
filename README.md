...
- `assets/img/photo-*.jpg` は、わんわんわんこ様からご提供いただいた写真（Zoho WorkDrive「202609_ご提供素材」）をWeb用に縮小したものです。`photo-dog.jpg`（わんわんデリバリーフーズ）はご提供いただいた犬の写真、`banner-*.jpg` は下層ページのバナー用にご提供写真を横長にトリミングしたものです。
