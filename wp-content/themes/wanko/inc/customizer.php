...
function wanko_defaults() {
	...
	return array(
		...
		'commitment_lead'  => "商品そのものだけでなく、選び方・届け方・その後のサポートまで。\n私たちが大切にしている4つのこだわりです。",
		...
		// 採用情報.
		'recruit_lead'     => "「ペットが好き」その気持ちを、仕事にしませんか。\n合同会社わんわんわんこでは、一緒に事業を育ててくれる仲間を募集しています。",
		'recruit_body'     => '',
...
function wanko_customize_register( $wp_customize ) {
	...
	$fields = array(
		...
		'banner_news_image'     => array( 'banners', 'お知らせ（推奨 1600×420px・横長）', 'image' ),
		'banner_column_image'   => array( 'banners', 'コラム（推奨 1600×420px・横長）', 'image' ),
		'banner_recruit_image'  => array( 'banners', '採用情報（推奨 1600×420px・横長）', 'image' ),
		'banner_contact_image'  => array( 'banners', 'お問い合わせ（推奨 1600×420px・横長）', 'image' ),
		...
		'shop_all_image'    => array( 'shop', '【総合】写真（推奨 1600×420px・横長）', 'image' ),
