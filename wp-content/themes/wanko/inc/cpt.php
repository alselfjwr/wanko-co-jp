 ...
 *
 * - お知らせ: standard "post" type (renamed in admin).
 * - コラム:   custom post type "column".
 *
 * @package Wanko
 */
...
add_action( 'init', 'wanko_register_column_cpt' );
...
/**
 * Default archive titles without the "アーカイブ:" prefix.
 */
